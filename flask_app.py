...
class QuizResult(Base):
    ...
    user_answers = Column(Text)  # JSON string
...
def generate_questions(topic: str, num_questions: int = 5, difficulty: str = "medium", seed: str = None) -> list:
    ...
    base_questions = [
        ...
        {
            "question": f"When was {topic} founded?",
            "answers": [
                {"text": "1800s", "correct": False},
                {"text": "1900s", "correct": True},
                {"text": "2000s", "correct": False},
                {"text": "1700s", "correct": False}
            ]
        },
        {
            "question": f"What is the national animal of {topic}?",
            "answers": [
                {"text": "Animal A", "correct": False},
                {"text": "Animal B", "correct": True},
                {"text": "Animal C", "correct": False},
                {"text": "Animal D", "correct": False}
            ]
        },
        {
            "question": f"What is the climate like in {topic}?",
            "answers": [
                    ...
                    <div class="login-card p-5">
                        ...
                        <div class="mt-4 text-center">
                            <small class="text-muted">
                                Generate unique AI-powered quizzes for each user
                            </small>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="login-card p-5">
                        <div class="text-center mb-4">
                            ...
                            <p class="text-muted">Welcome back to Quiz App</p>
                        </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="signup-card p-5">
                        <div class="text-center mb-4">
                            ...
                            <p class="text-muted">Create your Quiz App account</p>
                        </div>
...
def dashboard():
    ...
    <head>
        ...
        <style>
            ...
            .btn-primary { background: linear-gradient(90deg, #667eea 0%, #764ba2 100%); border: none; }
        </style>
    </head>
    <body>
                            ...
                            <form id="quizForm">
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="topic" placeholder="Any topic (e.g., France, Technology)" required>
                                    </div>
                                    <div class="col-md-6 mb-3">
